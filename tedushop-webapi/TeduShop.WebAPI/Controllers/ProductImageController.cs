...
namespace TeduShop.Web.Controllers
{
    ...
    public class ProductImageController : ApiControllerBase
    {
        ...
        [HttpPut]
        [Route("update")]
        public HttpResponseMessage Update(HttpRequestMessage request, ProductImageViewModel productViewModel)
        {
            return CreateHttpResponse(request, () =>
            {
                HttpResponseMessage response = null;
                ...
                {
                    var productDb = _productImageService.GetById(productViewModel.ID);
                    productDb.UpdateProductImage(productViewModel);
                    _productImageService.Update(productDb);
                    _productImageService.Save();
